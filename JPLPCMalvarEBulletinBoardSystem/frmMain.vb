...
Public Class frmMain
    ...
    Private Sub COURSENOTICEBOARDToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles COURSENOTICEBOARDToolStripMenuItem.Click
        frmNotification.ShowDialog()
    End Sub

    Private Sub ANNOUNCEMENTCONFIGURATIONToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles ANNOUNCEMENTCONFIGURATIONToolStripMenuItem.Click
